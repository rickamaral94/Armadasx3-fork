...
// The fork, not upstream: this button is how a user reaches the tracker for the
// build they are running, and only the fork's tracker can act on a fork bug.
// Upstream ARMSX3 and RPCS3 are credited and linked on the About screen.
private const val GithubUrl = "https://github.com/rickamaral94/Armadasx3-fork"
